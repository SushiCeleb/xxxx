...
import static sample.hello.specification.UnitLegSpecifications.*;
...
public class UnitLegService {
	@Autowired // リポジトリを紐づけます
	UnitLegRepository repository;
	 ...
	 * @return
	 */
	public List<UnitLeg> findLegs(String utName, String utSetType , Integer dAtk , Integer sAtk , Integer hAtk , Integer ability ,
