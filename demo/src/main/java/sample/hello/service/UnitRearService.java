...
import static sample.hello.specification.UnitRearSpecifications.*;
...
public class UnitRearService {
	@Autowired // リポジトリを紐づけます
	UnitRearRepository repository;
	...
	//検索のやつ
		 ...
		 * @return
		 */
		public List<UnitRear> findRears(String utName, String utSetType , Integer dAtk , Integer sAtk , Integer hAtk , Integer ability ,
